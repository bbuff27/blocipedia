...
RSpec.describe WikisController, type: :controller do
  ...
  context "guest" do
    ...
    describe "POST #create" do
      it "redirects guest users to the login screen" do
        post :create, params: { wiki: create(:wiki) }
        expect(response).to redirect_to(new_user_session_path)
      end
    end
  ...
  context "user" do
    ...
    describe "POST #create" do
      it "increases the number of wikis by 1" do
        expect { post :create, params: { wiki: create(:wiki) }}.to change(Wiki, :count).by(1)
      end
    ...
    describe "PUT #update" do
      it "updates wiki with expected attributes" do
        new_title = "This is a better title"
        new_body = "I think this is an even more intelligent explanation"
